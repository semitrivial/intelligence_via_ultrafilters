...
profound\footnote{To give an idea of the extreme profoundness of
Theorem \ref{ultrafilterexistence}: free ultrafilters are used in formalizations of
Kurt G\"odel's ontological argument for the
existence of God, see \citet{galvan}.} because it says these two
...
\section{Anticipated objections to Definition \ref{MainDefinition}}

In this section, we will attempt to anticipate objections to Definition \ref{MainDefinition}.

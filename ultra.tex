...
\begin{itemize}
    ...
    obtain a definition. If the constraints are appropriate, then we can formally say
    our definition is the \emph{only} definition possible, subject to those constraints!
